    ...
    <main className="flex flex-col gap-6 w-full max-w-[1440px] mx-auto p-0 focus:outline-none" tabIndex={-1}>
      ...
      {error ? (
        ...
        <div className="flex flex-col gap-6">
          {modulos.map((modulo) => (
            <div key={modulo.publicId} className="p-6 rounded-lg bg-fundo-aplicacao border border-borda flex flex-col gap-4">
              {/* Módulo */}
              ...
              {modulo.recursos.length > 0 ? (
                <div className="flex flex-col gap-4 mt-2">
                  {modulo.recursos.map((recurso) => (
                    <div key={recurso.publicId} className="p-4 rounded-md bg-fundo-superficie border border-borda flex flex-col gap-3">
                      <div className="flex flex-col gap-1">
